      ...
      <section className="py-24 bg-gradient-to-br from-purple-50 via-pink-50 to-orange-50 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 via-teal-600 to-cyan-600 mb-8 leading-tight">
              Pourquoi choisir Kivaia Kids ?
            </h2>
          </div>
          ...
          <div className="space-y-8 md:space-y-12">
            ...
            {/* Point 1 */}
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-6 md:p-8 shadow-xl border border-emerald-100 hover:shadow-2xl transition-all duration-300">
              <div className="flex items-start space-x-4 md:space-x-6">
                <div className="flex-shrink-0">
                  <div className="w-12 h-12 md:w-16 md:h-16 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-2xl flex items-center justify-center shadow-lg">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-700 text-base md:text-lg leading-relaxed">
                    Nous transformons l'apprentissage des langues en jeu d'exploration : l'enfant apprend
                    naturellement, sans pression, en s'amusant.
                  </p>
                </div>
              </div>
            </div>
            ...
            {/* Point 2 */}
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-6 md:p-8 shadow-xl border border-teal-100 hover:shadow-2xl transition-all duration-300">
              <div className="flex items-start space-x-4 md:space-x-6">
                <div className="flex-shrink-0">
                  <div className="w-12 h-12 md:w-16 md:h-16 bg-gradient-to-br from-teal-500 to-cyan-600 rounded-2xl flex items-center justify-center shadow-lg">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-700 text-base md:text-lg leading-relaxed mb-4">
                    Parce que chaque enfant mérite de devenir curieux du monde et fier de sa voix.
                    L'éveil aux langues, c'est bien plus que des mots :
                  </p>
                  <ul className="space-y-2 text-gray-700 text-base md:text-lg">
                    <li className="flex items-start space-x-2">
                      <span className="text-emerald-600 font-bold mt-1 text-2xl">•</span>
                      <span>C'est une porte ouverte sur la diversité et la culture.</span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <span className="text-emerald-600 font-bold mt-1 text-2xl">•</span>
                      <span>C'est une richesse pour mieux s'exprimer et mieux comprendre les autres.</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            {/* Point 3 */}
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-6 md:p-8 shadow-xl border border-cyan-100 hover:shadow-2xl transition-all duration-300">
              <div className="flex items-start space-x-4 md:space-x-6">
                <div className="flex-shrink-0">
                  <div className="w-12 h-12 md:w-16 md:h-16 bg-gradient-to-br from-cyan-500 to-blue-600 rounded-2xl flex items-center justify-center shadow-lg">
                    <span className="text-white font-bold text-lg md:text-xl">3</span>
                  </div>
                </div>
                <div className="flex-1">
                  <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-3 md:mb-4">
                    Un partenaire pour les adultes
                  </h3>
                  <p className="text-gray-700 text-base md:text-lg leading-relaxed mb-4">
                    Parents, enseignants, animateurs, assistants maternels: vous êtes les héros de cette
                    aventure.
                  </p>
                  <p className="text-gray-700 text-base md:text-lg leading-relaxed mb-4">
                    Avec Kivaia Kids, vous trouvez :
                  </p>
                  <ul className="space-y-2 text-gray-700 text-base md:text-lg">
                    <li className="flex items-start space-x-2">
                      <span className="text-emerald-600 font-bold mt-1 text-2xl">•</span>
                      <span>Des contenus adaptés et faciles à utiliser.</span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <span className="text-emerald-600 font-bold mt-1 text-2xl">•</span>
                      <span>Des activités prêtes à l'emploi qui nourrissent la curiosité naturelle des enfants.</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            {/* Point 4 */}
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-6 md:p-8 shadow-xl border border-blue-100 hover:shadow-2xl transition-all duration-300">
              <div className="flex items-start space-x-4 md:space-x-6">
                <div className="flex-shrink-0">
                  <div className="w-12 h-12 md:w-16 md:h-16 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-2xl flex items-center justify-center shadow-lg">
                    <span className="text-white font-bold text-lg md:text-xl">4</span>
                  </div>
                </div>
                <div className="flex-1">
                  <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-3 md:mb-4">
                    L'intelligence pédagogique alliée au plaisir
                  </h3>
                  <p className="text-gray-700 text-base md:text-lg leading-relaxed mb-4">
                    Chaque activité est conçue pour éveiller sans contraindre :
                  </p>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-xl p-4 text-center">
                      <p className="text-emerald-700 font-semibold text-sm md:text-base">Apprendre en jouant</p>
                    </div>
                    <div className="bg-gradient-to-br from-teal-50 to-cyan-50 rounded-xl p-4 text-center">
                      <p className="text-teal-700 font-semibold text-sm md:text-base">Explorer et ressentir</p>
                    </div>
                    <div className="bg-gradient-to-br from-cyan-50 to-blue-50 rounded-xl p-4 text-center">
                      <p className="text-cyan-700 font-semibold text-sm md:text-base">Grandir à son propre rythme</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {/* Point 5 */}
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-6 md:p-8 shadow-xl border border-indigo-100 hover:shadow-2xl transition-all duration-300">
              <div className="flex items-start space-x-4 md:space-x-6">
                <div className="flex-shrink-0">
                  <div className="w-12 h-12 md:w-16 md:h-16 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl flex items-center justify-center shadow-lg">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-700 text-base md:text-lg leading-relaxed">
                    Choisir Kivaia Kids, c'est offrir aux enfants un monde où la langue est un pont, pas une
                    barrière.
                  </p>
                </div>
              </div>
          ...
          <div className="text-center mt-12 md:mt-16">
            <Button
              ...
              size="lg"
              className="bg-gradient-to-r from-emerald-500 via-teal-500 to-cyan-500 hover:from-emerald-600 hover:via-teal-600 hover:to-cyan-600 text-white font-bold px-6 md:px-8 py-4 md:py-5 text-lg md:text-xl shadow-2xl hover:shadow-3xl transition-all duration-300 transform hover:-translate-y-1 hover:scale-105 rounded-2xl w-full sm:w-auto"
            >
              👉 Rejoindre Kivaia Kids
            </Button>
          </div>
        </div>
      </section>
